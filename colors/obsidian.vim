...
execute "hi Comment guifg="     . s:Colors[8]  . " guibg=none gui=italic"
execute "hi Conditional guifg=" . s:Colors[2]  . " guibg=none gui=none"
execute "hi Constant guifg="    . s:Colors[1]  . " guibg=none gui=none"
execute "hi Error guifg="       . s:Colors[7]  . " guibg=none gui=none"
execute "hi Identifier guifg="  . s:Colors[9]  . " guibg=none gui=none"
execute "hi Ignore guifg="      . s:Colors[1]
execute "hi Operator guifg="    . s:Colors[6]  . " guibg=none gui=none"
execute "hi PreProc guifg="     . s:Colors[0]  . " guibg=none gui=none"
execute "hi Repeat guifg="      . s:Colors[2]  . " guibg=none gui=none"
execute "hi Special guifg="     . s:Colors[2]  . " guibg=none gui=none"
execute "hi Statement guifg="   . s:Colors[2]  . " guibg=none gui=none"
execute "hi Number guifg="      . s:Colors[3]  . " guibg=none gui=none"
execute "hi Boolean guifg="     . s:Colors[11] . " guibg=none gui=none"
execute "hi String guifg="      . s:Colors[5]  . " guibg=none gui=none"
execute "hi Character guifg="   . s:Colors[5]  . " guibg=none gui=none"
execute "hi Title guifg="       . s:Colors[1]  . " guibg=none gui=none"
execute "hi Todo guifg="        . s:Colors[12] . " guibg=" . s:Colors[0]  . " gui=none guisp=NONE"
execute "hi Type guifg="        . s:Colors[9]  . " guibg=none gui=none"
execute "hi Underline guifg="   . s:Colors[10] . " guibg=none gui=none"
